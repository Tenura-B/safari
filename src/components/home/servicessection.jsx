...
const Services = () => {
  return (
    <section
      className="relative w-full min-h-screen text-white py-20 px-6 md:px-12 lg:px-24 overflow-hidden"
        ...
        <div className="hidden lg:flex lg:col-span-1 flex-col items-center gap-6 pt-32">
          {[1, 2, 3, 4, 5].map((item) => (
            ...
            >
              ...
              {item !== 5 && (
                <div className="w-px h-10 bg-linear-to-b from-yellow-500/50 to-transparent"></div>
              )}
            </div>
          ))}
        </div>
        ...
        >
          ...
          <header className="mb-16">
            <h4
              data-aos="fade-up"
              data-aos-duration="1500"
              className="text-yellow-500 text-2xl font-bold italic tracking-tighter"
            ...
            <p
              ...
              data-aos-duration="1500"
              data-aos-delay="200"
              className="text-[10px] tracking-[0.3em] uppercase text-gray-500 mb-4"
            >
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              ...
              <p
                ...
                data-aos-duration="1500"
                data-aos-delay="600"
                className="text-xs text-gray-400 max-w-xs leading-relaxed"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div
              ...
              data-aos-duration="1500"
              data-aos-delay="200"
              className="md:col-span-2 relative group overflow-hidden rounded-3xl border border-white/10 bg-white/5 backdrop-blur-sm p-8 h-75 flex flex-col justify-end"
            >
            ...
            <div
              ...
              data-aos-duration="1500"
              data-aos-delay="400"
              className="relative group overflow-hidden rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-8 flex flex-col justify-center items-center text-center"
            >
            ...
            <div
              ...
              data-aos-duration="1500"
              data-aos-delay="600"
              className="rounded-3xl border border-white/10 overflow-hidden h-75"
            >
            ...
            <div
              ...
              data-aos-duration="1500"
              data-aos-delay="800"
              className="md:col-span-2 relative group overflow-hidden rounded-3xl border border-white/10 bg-white/5 backdrop-blur-md p-8 h-75 flex flex-col justify-end"
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold mb-2">Luxury Camping</h3>
                <p className="text-xs text-gray-400 max-w-sm mb-6">
                  Sustainable glamping with premium amenities in the heart of the wild.
                </p>
                <button className="bg-yellow-500 text-black text-[10px] font-bold px-4 py-2 rounded-lg uppercase tracking-widest">
                  Explore More
                </button>
              </div>
            </div>
